export const config = {
	mapTitle: 'map-today-test', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-today-test.vercel.app', // The url provided when deploying the map on Vercel
